            ...
            <div key={item.title}>
              ...
              {item.links.map((link) => (
                <NavLink
                  ...
                  onClick={() => {}}
                  className={({ isActive }) => 
                  isActive ? activeLink : normalLink } // isActive is given to us straight by using the NavLink component belonging to react-router-dom
                  >
                  {link.icon}
